...
window.addEventListener('DOMContentLoaded', function () {
  // Запускається код коли весь DOM готовий
  'use strict';

  var modalState = {};
  var deadline = '2020-03-10';
...
var checkNumInputs = function checkNumInputs(selectors) {
  var numInputs = document.querySelectorAll(selectors);
...
/* harmony import */ var _chackNumInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chackNumInputs */ "./src/js/modules/chackNumInputs.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_chackNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_chackNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
...
/* harmony import */ var _chackNumInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chackNumInputs */ "./src/js/modules/chackNumInputs.js");
...
var forms = function forms(state) {
  ...
  Object(_chackNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name = "user_phone"]'); // Перевірка, якщо вводлять не число заміна пустою
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(item); // обэкт для збору структуризації даних з форми 
      ...
      postData('assets/server.php', formData).then(function (res) {
        // робимо щось із даними які прийшли і сидять в res
        console.log(res);
      ...
      .finally(function () {
        // метод промісу що виконається обовязково
        clearInputs();
        setTimeout(function () {
...
var images = function images() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.matches('div.popup')) {
      // метод який показуэ співпаддіня
      imgPopup.style.display = 'none';
    }
  });
};
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      //foreEach можна застосувати до колекції лише у випадку querySelectorAll
      item.addEventListener('click', function (e) {
        //вішаємо обработчики на всі елементи колекціїї
        if (e.target) {
          e.preventDefault();
        }
        ...
        // Те саме але з використанням бутсрапівських стилів
      });
      /*  */
    });
    ...
    modal.addEventListener('click', function (e) {
      // те саме по кліку поза модальним
  ...
  function showModalByTime(selector, time) {
    //поява модального вікна через певний час перебування користувача на сайті
    setTimeout(function () {
